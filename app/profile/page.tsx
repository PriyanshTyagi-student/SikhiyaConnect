        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div>
            <Card className="p-8 text-center">
              ...
              <p className="text-foreground/70 capitalize mb-6">{user.role}</p>
          ...
          <div className="lg:col-span-2">
            <Tabs defaultValue="account" className="w-full">
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={pref.label} className="flex items-start justify-between p-3 rounded-lg bg-white/40 dark:bg-white/5">
                        <div>
              ...
              <TabsContent value="security" className="space-y-6">
                ...
                <Card className="p-6 border-rose-200/60 dark:border-rose-800/40">
