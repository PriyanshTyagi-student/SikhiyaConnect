...
import { mockCourses, mockTeacherAnalytics, mockDiscussions } from '@/lib/mock-data';
...
export default function TeacherDashboardPage() {
  ...
  const [teacherCourses, setTeacherCourses] = useState<typeof mockCourses>({});
  ...
  useEffect(() => {
    ...
    // Mock: All courses belong to this teacher
    setTeacherCourses(mockCourses);
  }, [user, router]);
  ...
  const courseArray = Object.values(teacherCourses);
